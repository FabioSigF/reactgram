  ...
  return (
    <div className="profile">
        ...
        <>
          ...
          <div className="editPhoto hide" ref={editPhotoForm}>
            ...
            <form onSubmit={handleUpdate}>
              ...
              <button className='cancel_btn' onClick={handleCancelEdit}>Cancelar edição</button>
            </form>
          </div>
      ...
      <div className="userPhotos">
        ...
        <div className="userPhotos__container">
          {photos &&
            photos.map((photo) => (
              <div className="userPhotos__photo" key={photo._id}>
                {photo.image && (
                  <img
